const tarotDeck = [
    ...
    },
    {
        ...
        nameJs: "聖なる守護神たち",
        keyword: "絶対守護・無条件の愛",
        message: "【大吉・絶対守護】NOAの愛らしい守護神たちが、今日一日あなたをすべての厄災から守ってくれます。フクロウの知恵、ヘビの再生力、そして犬の無条件の愛が融合し、あなたに無敵の安心感を与えてくれるでしょう。今日は何をやっても安全で、心が温かくなるような優しい幸運に包まれます。",
        luckyAction: "深呼吸をして、守られている安心感を全身で感じる"
    },
    {
        // 24番目のカード（SPカード）
        number: "SP",
        ...
        nameJs: "運命のオアシス",
        keyword: "最高の縁・繁栄",
        message: "【最高大吉】みりゅうママの特別な加護が宿りました。今日のあなたは最強の引き寄せモード。素晴らしいご縁や、驚くようなチャンスが向こうからやってきます。自信を持って過ごしてください！",
        luckyAction: "夜はNOAに立ち寄って、さらに運気をブーストさせる"
    }
];
